...
\bigskip
\noindent\textbf{A szakdolgozat tárgyköre:} természetes nyelvfeldolgozás, szövegosztályozás, mélytanulás

\bigskip
\noindent\textbf{A szakdolgozat címe:} SPAM/HAM üzenetek osztályozása mélytanulási módszerekkel
...
\noindent A hallgató feladata egy SPAM/HAM szövegosztályozó rendszer megtervezése és megvalósítása mélytanulási módszerekkel. A dolgozatnak tartalmaznia kell:

\medskip
\begin{enumerate}
    \item A szövegosztályozás elméleti hátterének bemutatását. A hagyományos és mélytanulási módszerek összevetését és a szekvenciális modellek szerepét.
    \item A felhasznált adathalmaz részletes elemzését.
    \item Az előfeldolgozási folyamat kidolgozását és implementálását.
    \item Egy kétirányú LSTM (BiLSTM) modell megtervezését és megvalósítását.
    \item Az elvégzett kísérletek és a kapott eredmények bemutatását.
    \item A módszer korlátainak és továbbfejlesztési lehetőségeinek áttekintését.
\end{enumerate}
...
Alulírott \textbf{Ferencsik Róbert}; Neptun-kód: \texttt{BQLOTW} a Miskolci Egyetem Gépészmérnöki és Informatikai Karának végzős Programtervező informatikus szakos hallgatója ezennel büntetőjogi és fegyelmi felelősségem tudatában nyilatkozom és aláírásommal igazolom, hogy \textit{SPAM/HAM üzenetek osztályozása mélytanulási módszerekkel}
